...
$sql = "SELECT * FROM `vod` WHERE `name` LIKE '%$search%' ORDER BY `id` ASC LIMIT 200";
$result = $db->query($sql);
?>
...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <a href="vod.php?id=<?php echo($row['id']);?>" class="item">
                <img src="<?php echo($row['pic']);?>" class="cover"/>
                <div class="title">
                    <?php echo(mb_substr($row['name'],0,6,'UTF-8'));?>
                </div>
            </a>
